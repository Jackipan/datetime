...
;(function() {
  ...
  ;/msie (\d+\.\d)/i.test(navigator.userAgent) &&
    (A.fa.na = A.na = document.documentMode || +RegExp.$1)
  var ja = {
  ...
  A.U.la = function(a) {
    ...
    if (a.getBoundingClientRect) {
      ...
      if (c.opera > 0 || (c.WL > 0 && e(a, 'position') == 'absolute'))
  ...
  A.BK = (function() {
    ...
    a.prototype = {
      ...
      move: function(a) {
        ...
        if (
          10 <
            Math.abs((this.Ak ? a.touches[0].clientX : a.clientX) - this.Qt) ||
          10 < Math.abs(c - this.Rt)
        )
          this.oh = p
      },
      end: function(a) {
  ...
  D.C0 =
    ...
    function() {
      D.version &&
        D.version >= 1.5 &&
        oa(D.nd + '?qt=verify&ak=' + pa, function(a) {
          if (a && a.error !== 0) {
  ...
  function Ma(a, b) {
    if ((a = A.ea(a))) {
      ...
      Wa() &&
        Ta.load('oppc', function() {
          c.su()
        })
      I() &&
        Ta.load('opmb', function() {
          c.su()
        })
      a = q
      c.qB = []
  ...
  A.extend(Ma.prototype, {
    ...
    fk: function(a, b, c, e) {
      ...
      if ((c = c && e ? g.ii(c, this.Lb) : this.Tb))
        if (
          ((this.Tb = new J(c.lng + a * f, c.lat - b * f)),
    ...
    Ig: function(a, b) {
      if (
        ...
        c &&
          ((c = this.Qn(Ya(c, this.M.Ia), this.xc)),
          this.fk(
            this.width / 2 - c.x,
            this.height / 2 - c.y,
            this.kg(c, this.xc),
    ...
    Fr: function(a) {
      a &&
        $a(a.Ge) &&
        (a.Ge(this), this.dispatchEvent(new P('onaddcontrol', a)))
    },
    lN: function(a) {
      a &&
        $a(a.remove) &&
    ...
    jo: function(a) {
      a &&
        $a(a.ya) &&
        (a.ya(this), this.dispatchEvent(new P('onaddcontextmenu', a)))
    },
    mp: function(a) {
      a &&
        $a(a.remove) &&
    ...
    Pa: function(a) {
      a &&
        $a(a.Ge) &&
        (a.Ge(this), this.dispatchEvent(new P('onaddoverlay', a)))
    },
    Ob: function(a) {
      a &&
        $a(a.remove) &&
    ...
    m_: function(a) {
      a === ab || a === Sa
        ? (this.fy(p), this.EN(t), (this.M.sg = t), (this.M.ok = t))
        : (this.fy(t), this.EN(p), (this.M.sg = p), (this.M.ok = p))
    },
    tf: function(a) {
      var b = this
      if (a instanceof Q || a instanceof J)
      ...
      if (bb(a))
        if (c.Sa === Qa) {
          ...
          f.Ft(function(e) {
            if (
              0 === f.nm() &&
              (2 === f.Ma.result.type || 11 === f.Ma.result.type)
            ) {
              var g = e.xk(0).point,
    ...
    enableMapClick: function() {
      this.M.fm = p
      var a = this
      window.MPC_Mgr && window.MPC_Mgr[a.ca]
        ? window.MPC_Mgr[a.ca].open()
        : (setTimeout(function() {
            Ra(za)
          }, 1e3),
          Ta.load(
    ...
    disableMapClick: function() {
      window.MPC_Mgr &&
        window.MPC_Mgr[this.ca] &&
        window.MPC_Mgr[this.ca].close()
      this.M.fm = t
    },
    Do: function() {
      this.M.Do = p
      this.nn ||
        ((this.nn = new BuildingLayer({
          S2: p,
        })),
        this.Ne(this.nn))
    },
    ...
    xb: function() {
      return this.Wr && this.Wr instanceof N
        ? new N(this.Wr.width, this.Wr.height)
        : new N(this.ab.clientWidth, this.ab.clientHeight)
    },
    Be: function(a) {
      a && a instanceof N
        ? ((this.Wr = a),
          (this.ab.style.width = a.width + 'px'),
          (this.ab.style.height = a.height + 'px'))
        : (this.Wr = q)
    },
    Nb: function() {
    ...
    U4: function(a, b) {
      ...
      this.Sa === Qa &&
        c &&
        ((a.x += this.offsetX), (a.y += this.offsetY), gb.XJ(a, this, b))
    },
    te: function(a) {
      ...
      function b(a) {
        ...
        var b = D.nd + 'custom/v2/mapstyle',
          ...
          g =
            ...
            ('styles=' + encodeURIComponent(c.lF(a, f)))
        lb(b, g, window[e + 'cb'])
      }
      var c = this,
        e = this.ca
    ...
    y3: function(a, b) {
      ...
      b.styleJson
        ? (i +=
            'styles=' +
            encodeURIComponent(this.lF(b.styleJson, parseInt(a, 10))))
        : b.styleId &&
          (i += 'styles=' + encodeURIComponent(c.lF(c.L_, parseInt(a, 10))))
    ...
    Bt: function(a) {
      ...
      if (a) {
        ...
        a.style &&
          (c = b.M.UB[a.style]
            ? b.M.UB[a.style].backColor
            : b.M.UB.normal.backColor) &&
          (this.Ra().style.backgroundColor = c)
      }
    },
    jY: function(a) {
      this.controls ||
  ...
  function zb(a) {
    var b = eb()
    b >= a.xz
      ? ($a(a.m.za) && a.m.za(a.m.ac(1)),
        $a(a.m.finish) && a.m.finish(),
        0 < a.ag.length &&
          ((b = a.ag[0]), (b.ag = [].concat(a.ag.slice(1))), b.start()))
      : ((a.by = a.m.ac((b - a.uu) / a.m.duration)),
  ...
  wb.prototype.stop = function(a) {
    this.mF = p
    for (var b = 0; b < this.ag.length; b++) this.ag[b].stop(), (this.ag[b] = q)
    this.ag.length = 0
  ...
  A.fa.Re
    ? (A.extend(H, {
      ...
      A.platform.XL && (H.fontFamily = 'arial,simsun,sans-serif'))
    : A.fa.mw || A.fa.ay
    ? A.extend(H, {
          ...
          for (var c = a.target || a.srcElement; c != b; ) {
            Sb(b.nE, function(b, i) {
              RegExp(i.filter).test(c.getAttribute('filter')) &&
                i.ns.call(c, a, c.getAttribute('filter'))
            })
            c = c.parentNode
          }
        },
      ...
      if (v && v.th && m() < v.th) {
        var C = ['Moz', 'O', 'ms', 'Webkit'],
          ...
          sj = function() {
            return (
              !!b.createElementNS &&
              !!b.createElementNS('http://www.w3.org/2000/svg', 'svg').x2
            )
          },
          tj = function() {
            return !!a.h1
          ...
          Dj = function() {
            return !(
              !ca('exitFullscreen', b, t) && !ca('cancelFullScreen', b, t)
            )
          },
          Ej = function() {
            return !!ca('Intl', a)
        ...
        w.V('commit', function() {
          ...
          var a = setInterval(function() {
            if (
              'WebP-lossy' in $b.$h &&
              'WebP-lossless' in $b.$h &&
              'WebP-alpha' in $b.$h &&
              'WebP-animation' in $b.$h
            ) {
  ...
  function sc(a) {
    var b = tc,
      ...
      m = o.lng,
      o = o.lat
    if (1.0e-6 >= vc(m, o, i, k)) return (c.lng = e), (c.lat = f), c
    for (;;) {
      m = e - g
      o = f + g
      v = e - g
  ...
  wc.prototype.contains = function(a) {
    return a.lng > this.yg.lng &&
      a.lng < this.Fg.lng &&
      a.lat > this.yg.lat &&
      a.lat < this.Fg.lat
      ? mc
      : Math.abs(a.lng - this.yg.lng) < nc ||
        Math.abs(a.lng - this.Fg.lng) < nc ||
        Math.abs(a.lat - this.yg.lat) < nc ||
        Math.abs(a.y - this.Fg.lat) > nc
      ? 2
      : lc
  }
  wc.prototype.normalize = function(a, b, c, e) {
    a > c
      ? ((this.yg.lng = c), (this.Fg.lng = a))
      : ((this.yg.lng = a), (this.Fg.lng = c))
    b > e
      ? ((this.yg.lat = e), (this.Fg.lat = b))
      : ((this.yg.lat = b), (this.Fg.lat = e))
  }
  function xc(a, b, c, e) {
    this.Nt = {
      lng: a,
  ...
  function tc(a) {
    ...
    if ((0 === g ? lc : mc) === lc) {
      for (g = 0; g < Zb; ++g)
        if (
          ((e = new xc(ac[g], bc[g], ac[(g + 1) % Zb], bc[(g + 1) % Zb])),
          ...
          i = o - m
          var s = k - n
          !(Math.abs(i - 0) > nc) && !(Math.abs(s - 0) > nc)
            ? (i = e.Nt)
            : ((k = n * m - k * o),
              (m = s * a.lng - i * a.lat),
              (n = i * i - s * s),
          ...
          i.lng <= m && i.lng >= s && i.lng <= n && i.lat >= k
            ? ((e = a.lat * hc),
              ...
              -1 > e ? (e = -1) : 1 < e && (e = 1),
              (e = Math.acos(e) * oc))
            : ((i = yc(a, e.Nt)), (e = yc(a, e.Jw)), (e = i < e ? i : e))
          e < c && (c = e)
        }
      c < kc && (b = (kc - c) / kc)
    } else b = 1
    ...
    UJ: function(a) {
      if (a && this.WK()[a])
        for (var a = this.WK()[a], b = 0; b < a.length; b++)
          this.UJ(a[b]), this.Qd.tl[a[b]] || this.hN(a[b])
    },
    hN: function(a) {
  ...
  A.extend(Cc.prototype, {
    initialize: function(a) {
      this.P = a
      if (this.R) return a.ab.appendChild(this.R), this.R
    },
    Ge: function(a) {
      !this.R &&
        this.initialize && $a(this.initialize) &&
  ...
  A.object.extend(Nc.prototype, {
    ...
    removeItem: function(a) {
      if (a && 'menuitem' == a.Kb) {
        for (var b = 0, c = this.Aa.length; b < c; b++)
          this.Aa[b] === a && (this.Aa[b].remove(), this.Aa.splice(b, 1), c--)
        b = 0
        for (c = this.If.length; b < c; b++)
          this.If[b] === a && (this.If[b].remove(), this.If.splice(b, 1), c--)
      }
    },
    zB: function() {
      this.Aa.push({
    ...
    JE: function(a) {
      if (this.Ee[a]) {
        for (var b = 0, c = this.Aa.length; b < c; b++)
          this.Aa[b] &&
            'divider' == this.Aa[b].Kb && this.Aa[b].Ij == a &&
            (this.Aa.splice(b, 1), c--),
            this.Aa[b] &&
              'divider' == this.Aa[b].Kb && this.Aa[b].Ij > a &&
              this.Aa[b].Ij--
        this.Ee.splice(a, 1)
  ...
  A.object.extend(hb.prototype, {
    ...
    Sb: function(a) {
      return !(a instanceof hb) || this.rj()
        ? t
        : this.Ve().Sb(a.Ve()) && this.Qf().Sb(a.Qf())
    },
    Ve: x('Kl'),
    Qf: x('wl'),
    rV: function(a) {
      return !(a instanceof hb) || this.rj() || a.rj()
        ? t
        : a.Me > this.Me && a.He < this.He && a.Yd > this.Yd && a.Wd < this.Wd
    },
    Nb: function() {
      return this.rj()
        ? q
        : new Q((this.Me + this.He) / 2, (this.Yd + this.Wd) / 2)
    },
    Os: function(a) {
      if (
        !(a instanceof hb) ||
        Math.max(a.Me, a.He) < Math.min(this.Me, this.He) ||
        Math.min(a.Me, a.He) > Math.max(this.Me, this.He) ||
        Math.max(a.Yd, a.Wd) < Math.min(this.Yd, this.Wd) ||
        Math.min(a.Yd, a.Wd) > Math.max(this.Yd, this.Wd)
      )
        return q
    ...
    Mr: function(a) {
      return !(a instanceof Q || a instanceof J) || this.rj()
        ? t
        : a.lng >= this.Me &&
            a.lng <= this.He &&
            a.lat >= this.Yd &&
    ...
    sF: function() {
      return this.rj()
        ? new Q(0, 0)
        : new Q(Math.abs(this.He - this.Me), Math.abs(this.Wd - this.Yd))
    },
  })
  function Q(a, b) {
  ...
  A.extend(Vc.prototype, {
    ...
    Oc: function() {
      return !this.ba ||
        'none' == this.ba.style.display ||
        'hidden' == this.ba.style.visibility
        ? t
        : p
    },
  })
  ...
  D.Ze(function(a) {
    ...
    ;(A.fa.na && 8 > A.fa.na) || 'BackCompat' === document.compatMode
    ...
    a.addEventListener('clearoverlays', function() {
      ...
      for (var e = b.De.length; a < e; a++)
        b.De[a].enableMassClear !== t &&
          (b.De[a].remove(), (b.De[a] = q), b.De.splice(a, 1), a--, e--)
    })
  ...
  Xc.xE = [0.09, 0.005, 1.0e-4, 1.0e-5]
  A.extend(Xc.prototype, {
    ...
    Om: function(a, b) {
      b &&
        this.ka[a] &&
        ((this.ef.length = 0), (this.ka[a] = new Q(b.lng, b.lat)), this.zh())
    },
    ...
    eX: function() {
      for (var a = [], b = 0; b < this.ka.length - 1; b++)
        var c = this.WU(this.ka[b], this.ka[b + 1]), a = a.concat(c)
  ...
  A.extend(Yc.prototype, {
    Cj: function() {
      ...
      'none' != a.borderColor &&
        c.push('border:' + a.zx + 'px ' + a.KY + ' ' + a.hM + ';')
      c.push(
    ...
    initialize: function(a) {
      ...
      this.Cj()
      this.ba &&
        A.V(this.ba, I() ? 'touchstart' : 'mousedown', function(a) {
          ma(a)
        })
      return this.ba
    },
    draw: function() {
      ...
      this.K.Ea = new N(
        -Math.round(this.K.width / 2) - Math.round(this.K.zx),
        -Math.round(this.K.height / 2) - Math.round(this.K.zx)
      )
    ...
    g_: function(a, b) {
      ...
      this.ba &&
        ((this.ba.style.width = this.K.width + 'px'),
  ...
  function ad(a, b, c, e) {
    a &&
      ...
      (this.oI = !!(c.indexOf('%') + 1)),
      (this.repeat =
        c != l ? (this.oI ? parseFloat(c) / 100 : parseFloat(c)) : 0))
  }
  function bd(a, b) {
    A.lang.Ha.call(this)
    this.content = a
  ...
  A.extend(cd.prototype, {
    ...
    HN: function(a) {
      this.point = (this.Ln = a)
        ? (this.K.position = a.Oj())
        : (this.K.position = q)
    },
    Ww: function() {
      return this.Ln || q
  ...
  function md(a) {
    var b =
        ...
        (a.FU || a.i6 || a.F4 || a.G4 || a.K4 || a.FU || 1),
      c = a.canvas.width,
      e = a.canvas.height
    a.canvas.width = c * b
    a.canvas.height = e * b
  ...
  A.extend(nd.prototype, {
    ...
    Om: function(a, b) {
      this.bo[a] &&
        ((this.bo[a] = new Q(b.lng, b.lat)),
        (this.ka[a] = new Q(b.lng, b.lat)),
        0 == a &&
          !this.ka[0].Sb(this.ka[this.ka.length - 1]) &&
          (this.ka[this.ka.length - 1] = new Q(b.lng, b.lat)),
        this.zh())
    },
    Ue: function() {
      var a = this.bo
  ...
  A.extend(rd.prototype, {
    ...
    zf: function() {
      ...
      var a = this
      this.UD &&
        (this.map.dispatchEvent(new P('onfirsttileloaded')), (this.UD = t))
      0 == this.Dk &&
        (this.Ii && (clearTimeout(this.Ii), (this.Ii = q)),
    ...
    qL: function(a, b, c) {
      ...
      for (e = a.childNodes.length; n < e; n++)
        (y = a.childNodes[n]), (y.Lq = t), this.Oe.push(y)
      ...
      for (e = this.Oe.length; n < e; n++)
        (s = this.Oe[n]), s.Lq || this.Pe.push(s)
      this.pF = []
    ...
    E_: function(a, b, c, e) {
      ...
      m && m.Gb
        ...
        : (m = this.Zi[i]) && m.Gb
        ? (c.Ib.insertBefore(m.Gb, c.Ib.lastChild),
          (this.Ag[i] = m),
          Ab(m.Gb, b),
          e &&
            ((e = new R(a[0], a[1])),
    ...
    ZU: function(a, b) {
      for (
        var c = 256 * Math.pow(2, 18 - b),
          e = Math.floor(this.uA / c),
          f = Math.floor(this.vA / c),
          c = Math.floor(this.rA / c),
          g = [],
          i = 0;
        i < a.length;
        i++
      ...
      if (!this.map.M.sg) {
        ...
        if (b.map.wa() == Qa)
          Ta.load(
            ...
            function() {
              b.map.Lb ||
                ((b.map.Lb = Qa.sk(b.map.bh)), (b.map.nw = Qa.TK(b.map.Lb)))
              b.VH()
            },
            p
          )
    ...
    VH: function(a) {
      ...
      for (var k = 0; k < c; k++) {
        ...
        if (!m.G1 && !((m.vx && !this.map.Od()) || (m.VL && this.map.Od()))) {
          ...
          m.Ib &&
            ((m.Ib.style.left = Math.ceil(z + C) - g[0] + 'px'),
    ...
    Gg: function() {
      for (var a = this.tj, b = 0, c = a.length; b < c; b++) a[b].remove()
      delete this.Ib
      this.tj = []
      this.Zi = this.Ag = {}
      this.px()
    ...
    Bt: function(a) {
      var b = this.map.wa()
      if (!this.map.Od() && (a ? (this.map.M.N_ = a) : (a = this.map.M.N_), a))
        for (
          var c = q,
            c =
              '2' == D.$t
  ...
  A.extend(ud.prototype, {
    ...
    remove: function() {
      this.Ib &&
        this.Ib.parentNode &&
        ((this.Ib.innerHTML = ''), this.Ib.parentNode.removeChild(this.Ib))
      delete this.Ib
    },
    Vs: x('n0'),
    getTilesUrl: function(a, b) {
      ...
      var e = ''
      this.We.tileUrlTemplate &&
        ((e = this.We.tileUrlTemplate.replace(/\{X\}/, c)),
        (e = e.replace(/\{Y\}/, a.y)),
        (e = e.replace(/\{Z\}/, b)))
      return e
    },
  ...
  var Ld = {
        ...
        for (var a = a[6], k = 0; k < i.length; k++) {
          ...
          if (n && n.length)
            for (var o = i[k][1], s = 0; s < o.length; s++) {
              var v = o[s][1]
              f.Oc(v[0], c) &&
                (v['cache' + c] || (v['cache' + c] = f.Dm(v[1], c, e, a)),
                (v = v['cache' + c]),
    ...
    kW: function(a, b, c, e) {
      ...
      if (
        !c.Vb ||
        !(
          (6 < e && (71013 === c.Vb || 71012 === c.Vb || 71011 === c.Vb)) ||
          (6 === e && (71011 === c.Vb || 71012 === c.Vb)) ||
          (5 === e && (71011 === c.Vb || 71013 === c.Vb)) ||
          (5 > e && (71012 === c.Vb || 71013 === c.Vb))
        )
      ) {
        a.fillStyle = c.Mw
        a.beginPath()
  ...
  var Od = {
    parse: function(a, b, c, e, f) {
      for (
        ...
        for (
          ...
          a[w][E].aM
            ? this.$M(a[w][E].aM, z, e, b, c, B, C, i, k, s, v, y)
            : a[w][E].fY
            ? this.$M(a[w][E].fY, z, e, b, c, B, C, i, k, s, v, y, p, window.d4)
            : this.rZ(a[w][E].IY, z, e, b, c, B, C, i, k, s, v, y, f)
        m.push(y)
      }
      ...
      for (w = 0; w < a.length; w++)
        if (((c = a[w]), !c.Qs))
          if (
            ((E = [c.Uf, c.Vf, c.Uf, c.mi, c.li, c.mi, c.li, c.Vf, c.Uf, c.Vf]),
            c.style &&
              g.io('poi', E, {
                type: 'polygon',
                Vb: c.style.Vb,
    ...
    rZ: function(a, b, c, e, f, g, i, k, m, n, o, s, v) {
      ...
      if ((n = c.nj(a[0], 'pointText', k)) && n.length) {
        ...
        for (E = 2; E < B.length; E += 2)
          0 === E % (2 * z) ||
            1 === E % (2 * z) ||
            ((C[E] = C[E - 2] + B[E] / v), (C[E + 1] = C[E - 1] + B[E + 1] / v))
        for (v = 0; v < b; v++)
          if (c.Oc(a[7][v], k)) {
            var E = [],
              F = l,
            ...
            for (
              ...
              if (F === l)
                (F = Z - Ga / 2), (G = Aa - o / 2), (K = F + Ga), (O = G + o)
              else {
                var sa = Z - Ga / 2,
                  Va = Aa - o / 2
                sa < F && (F = sa)
    ...
    rK: function(a, b, c, e, f) {
      ...
      if (b.style && 62203 === s) {
        for (var v = (n = m = 0); v < b.vf.length; v++)
          m < b.vf[v].width && (m = b.vf[v].width), (n += 20)
        m = Math.ceil(m) + 10
      }
      e && 519 === s && (o = t)
      m !== q && n !== q
        ? this.jW(a, b, c, 8, m, n)
        : e && o
        ? ((m = Math.ceil(b.vf[0].width) + 6),
          this.cW(a, b, c, 12, m, c.height / 2))
    ...
    gW: function(a, b, c, e, f, g, i, k, m) {
      ...
      0 < k.fx &&
        ((a.lineWidth = k.fx), (a.strokeStyle = k.AL), a.strokeText(f, -g, -i))
      a.fillText(f, -g, -i)
      a.restore()
    },
    uK: function(a, b, c, e, f, g) {
      ...
      a.fillStyle = f.KK
      0 < f.fx &&
        ((a.lineWidth = f.fx), (a.strokeStyle = f.AL), a.strokeText(e, b, c))
      a.fillText(e, b, c)
    },
    Rw: function(a, b) {
      var c = a.fontSize / 2,
    ...
    EZ: function(a, b) {
            ...
            for (y = 0; y < z.length; y++) {
              ...
              o !== l
                ? (B.be < o && (o = B.be),
                  ...
                  B.ce + B.height > w && (w = B.ce + B.height))
                : ((o = B.be),
                  (s = B.ce),
                  (v = B.be + B.width),
                  (w = B.ce + B.height))
      ...
      for (g = c.length; f < g; f++) {
        ...
        for (k = f + 1; k < g; k++)
          (i = c[k]),
            m.li - e < i.Uf ||
              m.Uf > i.li - e || m.mi - e < i.Vf || m.Vf > i.mi - e ||
              m.CJ.push(k)
      }
      f = 0
      for (g = c.length; f < g; f++)
  ...
  var Ud = {
    drawLink: function(a, b, c, e, f) {
      ...
      var g = a[1]
      g &&
        ((a = a[6]), this.sO(g, c, e, b, a, f, p), this.sO(g, c, e, b, a, f, t))
    },
        ...
        if (n && n.length && (!i || n[0].borderWidth))
          if (!n[0].Jo || Td(n[0].Jo, b, this.ca))
            for (var o = a[k][1], s = 0; s < o.length; s++) {
              var v = o[s][3]
              g.Oc(v[0], b) &&
                (v['cache' + b] || (v['cache' + b] = g.Dm(v[1], b, c, f)),
                (v = v['cache' + b]),
  ...
  fe.prototype = {
    uC: function(a, b, c, e, f, g, i, k, m) {
      ...
      if (!window[o + 'StyleBody'] && 100 > m)
        ...
        window[o + 'zoomFrontStyle'][f].bmapLandColor &&
          (s.fillStyle = this.ZM(window[o + 'zoomFrontStyle'][f].bmapLandColor))
        o = b.style.width
        b.style.width = '0px'
        b.style.width = o
        s.fillRect(0, 0, g, g)
        if (a[0])
          for (o = 0; o < a[0].length; o++)
            (v = a[0][o]), v[0] === Xd && Ld.drawPoly(v, s, f, g, this)
        17 <= this.P.ja()
          ? (n.tK(a, s, f, g, i, c, e), (b.yn = p))
          : setTimeout(function() {
              if (!b.WG) {
                n.tK(a, s, f, g, i, c, e)
                b.yn = p
      ...
      if (a[0])
        for (var g = 0; g < a[0].length; g++) {
          var i = a[0][g],
            k = i[0]
          k === Wd
            ? Ud.drawLink(i, b, c, e, this)
            : k === $d
            ? Ud.drawLink(i, b, c, e, this)
            : k === Zd
            ? (Ld.drawGaoqingRoadBorder(i, b, c, e, this),
              Ld.drawGaoqingRoadFill(i, b, c, e, this))
            : 18 === k
            ? window[f + 'zoomFrontStyle'] &&
              window[f + 'zoomFrontStyle'][c] &&
                'off' !==
                  window[f + 'zoomFrontStyle'][c].bmapRoadarrowVisibility &&
              Md.drawArrow(i, b, c, e, Math.pow(2, c - ee[c].Mc), this)
            : k === Yd
            ? Nd.drawHregion(i, b, c, e, this)
            : 19 === k && Ud.drawSingleTexture(i, b, c, e, this)
        }
    },
    sK: function(a, b, c, e, f, g, i) {
      ...
      !window[m + 'StyleBody'] && 100 > i
        ...
        : (de || (de = b), (a.yZ = Od.parse(a, c, e, this, f)))
    },
    nj: function(a, b, c, e) {
      var f = a + '-' + b + '-' + c
      if (e) return ae[f] || (ae[f] = this.vg(a, b, c, e)), ae[f]
    ...
    for (k = a.length; b < k; b++) {
      ...
      if (B)
        (C = B.style),
          ...
          (C.height = f + 'px'),
          B.yn
            ? B.oF && B.oF && this.Rr.push(B.oF)
            : ((B.WG = p), (B.rB = q), delete B.rB, o.push([n, s, B]))
      else {
        if (0 < this.Pe.length) {
          var B = this.Pe.shift(),
            E = B.getContext('2d')
          ...
          this.dh[i] &&
            ...
            this.yF &&
              this.Ov.vC.uC(
                ...
                this.dh[i].Jm,
                this.dh[i].lE,
                this.Dd.Id(this.dh[i].lE),
                this.Dd.rD(this.dh[i].lE),
                this.cb.JD
              ))
      this.dh = f
    } else {
  ...
  function ie(a, b, c, e, f) {
    ...
    i[g].Sk = setTimeout(function() {
      3 > i[g].sN
        ? (i[g].sN++, (i[g].status = 'init'), ie(k, b, c, e, f))
        : (i[g] = q)
    }, 4e3)
  }
  function he(a) {
  ...
  pe.getTilesUrl = function(a, b, c) {
    ...
    return (
      ...
      '&scaler=' +
      g +
      (6 == A.fa.na ? '&color_dep=32&colors=50' : '') +
      '&udt=' +
      f +
      '&from=jsapi3_0'
    ).replace(/-(\d+)/gi, 'M$1')
  ...
  qe.getTilesUrl = function(a, b) {
    ...
    return (url =
      this.dO[Math.abs(c + e) % this.dO.length] +
      this.map.Lb +
      '/' +
      this.map.nw +
      '/3/lv' +
  ...
  A.extend(Oe.prototype, {
    ...
    DV: function() {
      ...
      this.page > this.Jd - this.Xf &&
        this.page >= this.Xf &&
        ((e = this.Jd - this.Xf + 1), (b = this.Jd))
      for (f = e; f <= b; f++)
        0 < f &&
          (f == this.page
  ...
  function Pa(a, b) {
      ...
      f.m.visible
        ? ('inter' === f.Je &&
          ...
          f.m.indoorExitControl === p
            ? A.U.show(f.Iq)
            : A.U.$(f.Iq),
          this.m.closeControl && this.Af && this.P && this.P.Ra() === this.R
            ? A.U.show(f.Af)
            : A.U.$(f.Af),
          this.m.forceCloseControl && A.U.show(f.Af))
        : (A.U.$(f.Af), A.U.$(f.Iq))
    }
    ...
    this.Yq = []
    'cvsRender' == this.$j || Oa()
      ? ((this.Sj = 90), (this.Uj = -90))
      : 'cssRender' == this.$j && ((this.Sj = 45), (this.Uj = -45))
    this.cr = t
    var f = this
    this.Jn = function() {
      this.$j === 'flashRender'
    ...
    this.m.rS !== p &&
      (this.Jn(), D.aq('cus.fire', 'count', 'z_loadpanoramacount'))
    this.jT(this.R)
  ...
  A.extend(Pa.prototype, {
    ...
    hy: function(a) {
      a !== this.Je &&
        ((this.Je = a), this.dispatchEvent(new P('onscene_type_changed')))
    },
    ON: function(a) {
      a !== kf && (kf = a)
    },
    ...
    va: function(a) {
      a.Sb(this.Jb) ||
        ((this.ql = this.fb), (this.rl = this.Jb), (this.Jb = a), (this.fb = q))
    },
    rd: function(a) {
      if (a) {
        var a = this.Ka.pitch,
    ...
    aB: function() {
      if (this.P)
        for (var a = this.P.Zw(), b = 0; b < a.length; b++)
          (a[b] instanceof W || a[b] instanceof cd) &&
            a[b].point &&
            this.Ba.push(a[b])
    },
    XE: ba('P'),
    ...
    Fq: function() {
      return Wa() && !I() && 'javascript' != this.m.panoramaRenderer
        ? 'flashRender'
        : !I() && Qb()
        ? 'cvsRender'
        : 'cssRender'
  ...
  A.extend(nf.prototype, {
    ...
    Dn: function() {
      var a = 0,
        ...
        c
      this.W &&
        ((b = this.W.la()), (c = this.la()) && !c.Sb(b) && (a = T.uk(b, c)))
      return a
    },
    $: function() {
      aa('hide\u65b9\u6cd5\u672a\u5b9e\u73b0')
          ...
          if (a.id != b.Iv) {
            ...
            a.Vl
              ? (b.wj({
                ...
                Wa() && b.m.closeControl && A.U.show(b.Iq))
              : A.U.$(b.Iq)
          }
        } else
          (b.fb = b.ql), (b.Jb = b.rl), b.dispatchEvent(new P('onnoresult'))
      }
      var b = this.W,
        c = this
  ...
  A.extend(wf, {
    WV: function(a, b, c) {
      ...
      'position_changed' == a &&
        (b.data = wf.Vd.vj(new R(b.data.mercatorX, b.data.mercatorY)))
    ...
    ML: function(a, b, c, e) {
      if (!b || !c || !c.lngLat || !c.panoInstance) e()
        ...
        this.Pn.LB(b, function(b) {
          b
            ? f.Pn.ij(c.lngLat, yf.dP, function(b) {
                if (b && b.id) {
                  var g = b.id,
                    m = b.ph,
                    b = b.qh,
  ...
  function eg(a, b) {
    ...
    c.options.Uk
      ? (c.Pb.style[Jf] = 'translate(' + c.x + 'px,' + c.y + 'px)' + dg)
      : (c.Pb.style.cssText +=
    ...
    !Sf &&
      'none' != c.options.JO &&
      (c.ga('DOMMouseScroll'), c.ga('mousewheel'))
    c.options.lw &&
      (c.dV = setInterval(function() {
        c.eQ()
      }, 500))
    this.options.gx &&
      (Event.prototype.stopImmediatePropagation ||
        ((document.body.removeEventListener = function(a, b, c) {
          ...
          a === 'click'
            ? e.call(document.body, a, b.CL || b, c)
  ...
  eg.prototype = {
    ...
    eQ: function() {
      !this.oh &&
        !this.Xk &&
          !(
            this.Sl ||
            (this.dy == this.Pb.offsetWidth * this.scale &&
              this.sp == this.Pb.offsetHeight * this.scale)
          ) &&
        this.refresh()
    },
    sv: function(a) {
      ...
      this[a + 'Scrollbar']
        ? (this[a + 'ScrollbarWrapper'] ||
            ...
            this.options.NE
              ? (b.className = this.options.NE + a.toUpperCase())
              : (b.style.cssText =
    ...
    VA: function(a, b) {
      ...
      this[a + 'Scrollbar'] &&
        ...
        0 > c
          ? (this.options.UC ||
              ((c = this[a + 'ScrollbarIndicatorSize'] + Af.round(3 * c)),
              8 > c && (c = 8),
          ...
          : c > this[a + 'ScrollbarMaxScroll'] &&
            (this.options.UC
              ...
              : ((c =
                  ...
                  Af.round(3 * (c - this[a + 'ScrollbarMaxScroll']))),
                8 > c && (c = 8),
                (this[a + 'ScrollbarIndicator'].style[
                  'h' == a ? 'width' : 'height'
                ] = c + 'px'),
        ...
        (this[a + 'ScrollbarWrapper'].style.opacity =
          b && this.options.kx ? '0' : '1'),
        (this[a + 'ScrollbarIndicator'].style[Jf] =
          'translate(' + ('h' == a ? c + 'px,0)' : '0,' + c + 'px)') + dg))
    },
    oQ: function(a) {
      if (a.eR === p) return (this.uB = a.target), (this.Lw = Date.now()), p
      if (this.uB && this.Lw) {
        if (600 < Date.now() - this.Lw) return (this.Lw = this.uB = q), p
      } else {
    ...
    Bv: function(a) {
      ...
      if (this.enabled) {
        ...
        this.options.zoom &&
          Sf && 1 < a.touches.length &&
          ((e = Af.abs(a.touches[0].pageX - a.touches[1].pageX)),
          (c = Af.abs(a.touches[0].pageY - a.touches[1].pageY)),
          (this.e0 = Af.sqrt(e * e + c * c)),
          (this.Mx =
            Af.abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.FF) / 2 -
            this.x),
          (this.Nx =
            Af.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.GF) / 2 -
            this.y),
          this.options.jp && this.options.jp.call(this, a))
        if (
          this.options.Ex &&
          (this.options.Uk
            ? ((c = getComputedStyle(this.Pb, q)
                [Jf].replace(/[^0-9\-.,]/g, '')
                .split(',')),
              (e = +(c[12] || c[4])),
              (c = +(c[13] || c[5])))
            : ((e = +getComputedStyle(this.Pb, q).left.replace(/[^0-9-]/g, '')),
    ...
    GS: function(a) {
      ...
      if (this.options.zoom && Sf && 1 < a.touches.length)
        (f = Af.abs(a.touches[0].pageX - a.touches[1].pageX)),
          ...
          b < this.options.Wk
            ? (b = 0.5 * this.options.Wk * Math.pow(2, b / this.options.Wk))
            : b > this.options.Lp &&
              (b = 2 * this.options.Lp * Math.pow(0.5, this.options.Lp / b)),
          (this.cp = b / this.scale),
          (f = this.Mx - this.Mx * this.cp + this.x),
          (g = this.Nx - this.Nx * this.cp + this.y),
          (this.Pb.style[Jf] =
            'translate(' + f + 'px,' + g + 'px) scale(' + b + ')' + dg),
        ...
        ;(6 > this.Tv && 6 > this.Uv) ||
          (this.options.jE &&
            (this.Tv > this.Uv + 5
              ? ((g = this.y), (e = 0))
              : this.Uv > this.Tv + 5 && ((f = this.x), (c = 0))),
          (this.oh = p),
          this.br(f, g),
          (this.jC = 0 < c ? -1 : 0 > c ? 1 : 0),
          (this.kC = 0 < e ? -1 : 0 > e ? 1 : 0),
          300 < i - this.startTime &&
            ((this.startTime = i), (this.Qt = this.x), (this.Rt = this.y)),
      ...
      if (!(Sf && 0 !== a.touches.length)) {
        ...
        if (b.Xk)
          ...
          if (b.oh) {
            ...
            g.Ga || i.Ga
              ? ((c = Af.max(Af.max(g.time, i.time), 10)),
                b.options.Mt &&
                  ((g = e - b.Vv),
                  (i = f - b.Wv),
                  Af.abs(g) < b.options.oy && Af.abs(i) < b.options.oy
                    ? b.scrollTo(b.Vv, b.Wv, 200)
                    : ((g = b.OI(e, f)),
                      (e = g.x),
                      (f = g.y),
                      (c = Af.max(g.time, c)))),
                b.scrollTo(Af.round(e), Af.round(f), c))
              : b.options.Mt
              ? ((g = e - b.Vv),
                (i = f - b.Wv),
                Af.abs(g) < b.options.oy && Af.abs(i) < b.options.oy
    ...
    Sn: function(a) {
      ...
      if (b == this.x && c == this.y) {
        if (
          (this.oh &&
            ((this.oh = t), this.options.Kx && this.options.Kx.call(this)),
          this.ei &&
            this.options.kx &&
            ('webkit' == Cf && (this.zL.style[Of] = '300ms'),
    ...
    OI: function(a, b) {
      ...
      a = this.Xe[f]
      e = (e = Af.abs(a - this.Xe[this.aC]))
        ? 500 * (Af.abs(this.x - a) / e)
        : 0
      this.aC = f
      f = this.rf.length - 1
      for (c = 0; c < f; c++)
      ...
      b = this.rf[f]
      c = (c = Af.abs(b - this.rf[this.bC]))
        ? 500 * (Af.abs(this.y - b) / c)
        : 0
      this.bC = f
    ...
    refresh: function() {
      ...
      this.Vm =
        this.options.Vm && ((!this.options.RU && !this.Xo) || this.sp > this.Zm)
      ...
      if ('string' == typeof this.options.Mt) {
        ...
        for (this.Xe = []; e >= this.he; ) (this.Xe[b] = e), (e -= this.du), b++
        this.he % this.du &&
          (this.Xe[this.Xe.length] =
            this.he - this.Xe[this.Xe.length - 1] + this.Xe[this.Xe.length - 1])
        b = e = 0
        for (this.rf = []; e >= this.qd; ) (this.rf[b] = e), (e -= this.Zm), b++
        this.qd % this.Zm &&
          (this.rf[this.rf.length] =
            this.qd - this.rf[this.rf.length - 1] + this.rf[this.rf.length - 1])
      }
      this.sv('h')
      this.sv('v')
    ...
    scrollTo: function(a, b, c, e) {
      ...
      for (b = f.length; a < b; a++)
        f[a].IZ && ((f[a].x = this.x - f[a].x), (f[a].y = this.y - f[a].y)),
          this.xj.push({
            x: f[a].x,
            y: f[a].y,
            time: f[a].time || 0,
    ...
    zoom: function(a, b, c, e) {
      ...
      this.options.Uk &&
        ...
        (this.y =
          this.y > this.pf ? this.pf : this.y < this.qd ? this.qd : this.y),
        (this.Pb.style[Lf] = e + 'ms'),
        (this.Pb.style[Jf] =
          'translate(' + this.x + 'px,' + this.y + 'px) scale(' + c + ')' + dg),
        (this.Xk = t))
    },
  }
  function If(a) {
  ...
  D.Gk(function(a) {
    ...
    a.addEventListener('position_changed', function() {
      a.m.visible &&
        a.m.albumsControl === p &&
        (b ? b.Yx(a.Wb()) : ((b = new fg(a.m.albumsControlOptions)), b.ya(a)))
    })
  ...
  A.extend(fg.prototype, {
    ...
    Yx: function(a, b) {
      if (
        b ||
        !this.Yj[this.Xc] ||
        !(this.Yj[this.Xc].panoId == a && 3 !== this.Yj[this.Xc].recoType)
      ) {
        var c = this,
          e = this.oH(a)
        !b && -1 !== e && this.Yj[e] && 3 !== this.Yj[e].recoType
          ? this.wp(e)
          : this.BX(function(a) {
              for (
    ...
    BV: function() {
      if (this.Hi) (a = this.SK(this.Ki)), (this.cQ.innerHTML = a)
      else {
          ...
          if ((a = (a.srcElement || a.target).getAttribute('dataindex'))) {
            ...
            for (
              ...
              e[f].childNodes[0].getAttribute('dataindex') === a
                ? A.U.hb(e[f], 'pano_catlogLiActive')
        ...
        var a = L('div'),
          ...
          i = L('span'),
          k = [
            'background:url(' + H.sa + 'panorama/catlog_icon.png) no-repeat;',
    ...
    CV: function() {
      if (this.Ki && !(0 >= this.Ki.length)) {
        ...
        this.Hi &&
          (this.Hi.style.left =
            parseInt(this.Hi.style.left, 10) + this.fg.width + 8 + 'px')
        var b = this
    ...
    El: function(a) {
      ...
      this.m.showCatalog &&
        (0 < this.Ki.length
          ? (Wa() ? this.BV() : this.EV(), (this.Rc.offsetLeft = 60))
          : (this.js &&
              (this.R.removeChild(this.js),
              (this.js = q),
              (this.Rc.hg.style.left = '0px')),
            this.Hi && (this.R.removeChild(this.Hi), (this.Hi = q)),
            (this.Rc.offsetLeft = 0)))
      var b = this.iX(a)
      Wa() &&
        this.Ki && 0 < this.Ki.length && this.m.showExit && this.zz &&
        ((this.Rc.offsetLeft += this.fg.width + 8),
      ...
      b < a - 2 * this.Rc.Ai - this.Rc.offsetLeft
        ? (this.R.style.width = b + this.Rc.offsetLeft + 'px')
        : ((this.R.style.width =
            isNaN(Number(this.m.maxWidth)) === p
              ? this.m.maxWidth
              : this.m.maxWidth + 'px'),
          b < this.R.offsetWidth - 2 * this.Rc.Ai - this.Rc.offsetLeft &&
            (this.R.style.width = b + this.Rc.offsetLeft + 'px'))
      this.Rc.refresh()
    ...
    iX: function(a) {
      for (
        var b, c, e, f, g = [], i = this.fg.height, k = this.fg.width, m = 0;
        m < a.length;
        m++
      )
        (b = a[m]),
          ...
          3 === recoType
            ? Wa()
              ? ((this.zz = b), (this.xW = e), a.splice(m, 1), m--)
              : ((b =
                  '<a href="javascript:void(0);" class="pano_photo_item" data-index="' +
                  m +
                  '"><img style="width:' +
  ...
  jg.prototype = {
    ...
    refresh: function() {
      ...
      this.hg &&
        (this.hg.children[0].style.marginTop = this.jr.children[0].style.marginTop =
          this.hg.offsetHeight / 2 -
          this.hg.children[0].offsetHeight / 2 +
          'px')
    },
    ss: function() {
      return 2 * this.Ai
    ...
    Or: function() {
      ...
      this.hg.children[0].style.marginTop = this.jr.children[0].style.marginTop =
        this.hg.offsetHeight / 2 - this.hg.children[0].offsetHeight / 2 + 'px'
    },
    HB: function() {
      var a = this
    ...
    scrollTo: function(a) {
      a =
        a < this.Xg.offsetLeft
          ? Math.ceil((a - this.Ai - this.Nn) / this.rr) * this.rr +
            this.Nn +
            this.Ai -
            8
          : Math.ceil((a - this.Ai) / this.rr) * this.rr + this.Ai
